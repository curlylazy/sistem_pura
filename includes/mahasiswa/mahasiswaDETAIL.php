...
<div class="col-md-12">
	<div class="box box-warning">
            ...
            <div class="row">
                <div class="form-group col-md-12">
                    ...
                    <select class="form-control" name="statusmahasiswa" id="statusmahasiswa">
                        ...
                        <option value='1'>Dalam Verifikasi</option>  
                        <option value='2'>Aktif</option>  
                        <option value='3'>Lulus</option>  
                        <option value='4'>DO / Berhenti</option>  
                    </select>
                </div>
            </div>
		...
		<div class="box-footer">
			<a class="btn btn-default" href="?page=<?= $arr['prefix'] ?>&act=informasi"><span class="fa fa-backward"></span> KEMBALI</a>
		</div>
