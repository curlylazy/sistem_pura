...
$(document).ready(function() {
    ...
    $("#preview").click(function() {
        $("#form1").attr("action", "<?= "index.php?page=laporan&act=itemkeluar"; ?>");
        $("#form1").submit();
    });

    $("#cetak").click(function() {
        $("#form1").attr("action", "<?= "$actcetak?cetak=itemkeluar"; ?>");
        $("#form1").submit();
    });
                    ...
                    <tbody>
                        ...
                        while($row = $sth->fetch())
                        {
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class='btn-group'>
										<a class='btn btn-default btn-xs' href='$actcetak?cetak=itemkeluardetail&id=$row[kodeitemkeluar]' onClick=\"return confirm('Cetak data detail transaksi $row[kodeitemkeluar] ?')\">
